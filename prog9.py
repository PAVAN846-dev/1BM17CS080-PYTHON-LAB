...
class Application(Frame):
	...
	def create_widgets(self):
		...
		Checkbutton(self,variable= self.movieselect1,text="Joker").grid(row=4,column=0,sticky=W)
		Checkbutton(self,variable= self.movieselect2,text="KGF").grid(row=4,column=1,sticky=W)
		Checkbutton(self,variable= self.movieselect3,text="War").grid(row=4,column=2,sticky=W)
